...
- Goals, expectations, big questions (15 minutes)

**System Setup (1 hour)**
- Understanding "what" Python is
- Python setup and interaction
...
**What's Next (1 hour)**
- How to think about Python and incorporate it into your work (15 minutes)
- Brainstorming applications of Python (45 minutes)
- Possible future training, office hours, and more (optional, discussion)
